...
from simulator.improved_traffic_generator import TrafficGenerator, TrafficType, PriorityLevel
import simpy
import logging
...
from simulator.custom_traffic_generator import EnhancedTrafficGenerator
...
class Simulator:
    ...
    def __init__(self,
        ...
        # 添加以下代码以保持向后兼容
        self.generate_traffic_requirement = self.traffic_generator.create_traffic_requirement
        self.traffic_manager = SequentialTrafficManager(self)
        # self.traffic_generator.generate_traffic_requirement(
        #     source_id=4,
        #     dest_id=9,
        #     num_packets=100,
        #     delay_req=1000,  # ms
